...
class Assets {
  ...
  @override
  String toString() => 'Assets[schema=$schema, iterable=$iterable, indices=$indices, score=$score]';
  ...
  static Assets? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Assets(
        ...
        iterable: Asset.listFromJson(json[r'iterable']),
  ...
  static Map<String, dynamic> mapToJson(Map<String, Assets> map) {
