...
class FlattenedPerson {
  ...
  @override
  String toString() => 'FlattenedPerson[schema=$schema, id=$id, created=$created, updated=$updated, deleted=$deleted, type=$type, assets=$assets, mechanisms=$mechanisms, interactions=$interactions, access=$access, tags=$tags, websites=$websites, models=$models, annotations=$annotations, score=$score]';
