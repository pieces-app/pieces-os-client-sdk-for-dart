...
import '/model/flattened_user_profile.dart' show FlattenedUserProfile;
...
class Accessor {
  ...
  @override
  String toString() => 'Accessor[schema=$schema, id=$id, os=$os, share=$share, count=$count, user=$user]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Accessor> map) {
