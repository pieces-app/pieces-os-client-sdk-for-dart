...
class Anchor {
  ...
  @override
  String toString() => 'Anchor[schema=$schema, id=$id, name=$name, type=$type, watch=$watch, points=$points, created=$created, updated=$updated, deleted=$deleted, assets=$assets, annotations=$annotations, conversations=$conversations, score=$score]';
