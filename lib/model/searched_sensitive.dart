...
class SearchedSensitive {
  ...
  @override
  String toString() => 'SearchedSensitive[exact=$exact, identifier=$identifier, schema=$schema, sensitive=$sensitive, similarity=$similarity, temporal=$temporal]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.sensitive != null) {
      json[r'sensitive'] = this.sensitive;
    } else {
      json[r'sensitive'] = null;
    }
