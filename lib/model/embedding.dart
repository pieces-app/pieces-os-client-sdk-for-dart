...
class Embedding {
  ...
  @override
  String toString() => 'Embedding[raw=$raw, model=$model, created=$created, updated=$updated, deleted=$deleted]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Embedding> map) {
