...
import '/model/external_ml_provider_enum.dart' show ExternalMLProviderEnum;
import '/model/grouped_timestamp.dart' show GroupedTimestamp;
import '/model/model_foundation_enum.dart' show ModelFoundationEnum;
import '/model/model_type_enum.dart' show ModelTypeEnum;
import '/model/model_usage_enum.dart' show ModelUsageEnum;
...
class Model {
  ...
  @override
  String toString() => 'Model[schema=$schema, id=$id, version=$version, created=$created, name=$name, description=$description, cloud=$cloud, type=$type, usage=$usage, bytes=$bytes, ram=$ram, quantization=$quantization, foundation=$foundation, downloaded=$downloaded, loaded=$loaded, unique=$unique, parameters=$parameters, provider=$provider, cpu=$cpu, downloading=$downloading]';
