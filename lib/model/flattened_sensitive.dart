...
import '/model/sensitive_category_enum.dart' show SensitiveCategoryEnum;
import '/model/sensitive_metadata.dart' show SensitiveMetadata;
import '/model/sensitive_severity_enum.dart' show SensitiveSeverityEnum;
...
class FlattenedSensitive {
  ...
  @override
  String toString() => 'FlattenedSensitive[schema=$schema, id=$id, created=$created, updated=$updated, deleted=$deleted, asset=$asset, text=$text, mechanism=$mechanism, category=$category, severity=$severity, name=$name, description=$description, metadata=$metadata, interactions=$interactions, score=$score]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, FlattenedSensitive> map) {
