...
import '/model/referenced_user.dart' show ReferencedUser;
import '/model/seeded_connector_tracking.dart' show SeededConnectorTracking;
...
class SeededActivity {
  ...
  @override
  String toString() => 'SeededActivity[event=$event, application=$application, asset=$asset, user=$user, format=$format, mechanism=$mechanism]';
