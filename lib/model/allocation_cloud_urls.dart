...
import '/model/allocation_cloud_url.dart' show AllocationCloudUrl;
...
class AllocationCloudUrls {
  ...
  @override
  String toString() => 'AllocationCloudUrls[schema=$schema, base=$base, id=$id, vanity=$vanity]';
  ...
  static AllocationCloudUrls? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AllocationCloudUrls(
        ...
        base: AllocationCloudUrl.fromJson(json[r'base'])!,
