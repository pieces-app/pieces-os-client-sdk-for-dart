...
class FlattenedIdentifiedWorkstreamPatternEngineSource {
  /// Returns a new [FlattenedIdentifiedWorkstreamPatternEngineSource] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FlattenedIdentifiedWorkstreamPatternEngineSource &&
  ...
  @override
  String toString() => 'FlattenedIdentifiedWorkstreamPatternEngineSource[accessibility=$accessibility, anchors=$anchors, conversations=$conversations, created=$created, filter=$filter, id=$id, messages=$messages, name=$name, persons=$persons, raw=$raw, schema=$schema, summaries=$summaries, updated=$updated, websites=$websites, workstreamPatternEngineSourcesVector=$workstreamPatternEngineSourcesVector, workstreamEvents=$workstreamEvents]';
  ...
  /// Returns a new [FlattenedIdentifiedWorkstreamPatternEngineSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FlattenedIdentifiedWorkstreamPatternEngineSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FlattenedIdentifiedWorkstreamPatternEngineSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FlattenedIdentifiedWorkstreamPatternEngineSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FlattenedIdentifiedWorkstreamPatternEngineSource(
  ...
  static List<FlattenedIdentifiedWorkstreamPatternEngineSource> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FlattenedIdentifiedWorkstreamPatternEngineSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FlattenedIdentifiedWorkstreamPatternEngineSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FlattenedIdentifiedWorkstreamPatternEngineSource> mapFromJson(dynamic json) {
    final map = <String, FlattenedIdentifiedWorkstreamPatternEngineSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FlattenedIdentifiedWorkstreamPatternEngineSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FlattenedIdentifiedWorkstreamPatternEngineSource-objects as value to a dart map
  static Map<String, List<FlattenedIdentifiedWorkstreamPatternEngineSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FlattenedIdentifiedWorkstreamPatternEngineSource>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FlattenedIdentifiedWorkstreamPatternEngineSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
