...
class QGPTTaskPipeline {
  ...
  @override
  String toString() => 'QGPTTaskPipeline[codeCommentation=$codeCommentation, codeCompletion=$codeCompletion, codeExplanation=$codeExplanation, codeFix=$codeFix, codeModification=$codeModification, schema=$schema]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.codeCommentation != null) {
      json[r'code_commentation'] = this.codeCommentation;
    } else {
      json[r'code_commentation'] = null;
    }
    if (this.codeCompletion != null) {
      json[r'code_completion'] = this.codeCompletion;
    } else {
      json[r'code_completion'] = null;
    }
    if (this.codeExplanation != null) {
      json[r'code_explanation'] = this.codeExplanation;
    } else {
      json[r'code_explanation'] = null;
    }
    if (this.codeFix != null) {
      json[r'code_fix'] = this.codeFix;
    } else {
      json[r'code_fix'] = null;
    }
    if (this.codeModification != null) {
      json[r'code_modification'] = this.codeModification;
    } else {
      json[r'code_modification'] = null;
    }
    if (this.schema != null) {
