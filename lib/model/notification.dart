...
class Notification {
  ...
  @override
  String toString() => 'Notification[schema=$schema, id=$id, title=$title, message=$message, payload=$payload]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Notification> map) {
