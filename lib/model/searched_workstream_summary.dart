...
class SearchedWorkstreamSummary {
  ...
  @override
  String toString() => 'SearchedWorkstreamSummary[annotations=$annotations, exact=$exact, identifier=$identifier, schema=$schema, similarity=$similarity, summary=$summary, temporal=$temporal]';
