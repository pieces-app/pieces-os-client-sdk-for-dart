...
import '/model/tracked_application.dart' show TrackedApplication;
import '/model/tracked_asset_event.dart' show TrackedAssetEvent;
import '/model/tracked_assets_event.dart' show TrackedAssetsEvent;
import '/model/tracked_format_event.dart' show TrackedFormatEvent;
import '/model/tracked_interaction_event.dart' show TrackedInteractionEvent;
import '/model/tracked_keyboard_event.dart' show TrackedKeyboardEvent;
import '/model/tracked_session_event.dart' show TrackedSessionEvent;
import '/model/tracked_user_profile.dart' show TrackedUserProfile;
...
class TrackedSegmentEventProperties {
  ...
  @override
  String toString() => 'TrackedSegmentEventProperties[os=$os, application=$application, user=$user, asset=$asset, format=$format, interaction=$interaction, keyboard=$keyboard, session=$session, assets=$assets]';
  ...
  static TrackedSegmentEventProperties? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TrackedSegmentEventProperties(
        ...
        application: TrackedApplication.fromJson(json[r'application'])!,
