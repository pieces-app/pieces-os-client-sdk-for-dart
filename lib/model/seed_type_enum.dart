...
class SeedTypeEnum {
  ...
  static const UNKNOWN = SeedTypeEnum._(r'UNKNOWN');
  static const SEEDED_FORMAT = SeedTypeEnum._(r'SEEDED_FORMAT');
  static const SEEDED_ASSET = SeedTypeEnum._(r'SEEDED_ASSET');
...
class SeedTypeEnumTypeTransformer {
  ...
  SeedTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'UNKNOWN': return SeedTypeEnum.UNKNOWN;
        case r'SEEDED_FORMAT': return SeedTypeEnum.SEEDED_FORMAT;
        case r'SEEDED_ASSET': return SeedTypeEnum.SEEDED_ASSET;
        default:
          if (!allowNull) {
