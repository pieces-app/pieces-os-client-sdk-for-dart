...
import '/model/qgpt_relevance_input_options.dart' show QGPTRelevanceInputOptions;
import '/model/seeds.dart' show Seeds;
...
class QGPTRelevanceInput {
  ...
  @override
  String toString() => 'QGPTRelevanceInput[schema=$schema, query=$query, paths=$paths, seeds=$seeds, assets=$assets, messages=$messages, options=$options, application=$application, model=$model]';
