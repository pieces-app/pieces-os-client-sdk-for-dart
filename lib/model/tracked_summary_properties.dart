...
import '/model/applications.dart' show Applications;
import '/model/tracked_summary_totals.dart' show TrackedSummaryTotals;
...
class TrackedSummaryProperties {
  ...
  @override
  String toString() => 'TrackedSummaryProperties[applications=$applications, totals=$totals, user=$user, acquired=$acquired, interval=$interval]';
