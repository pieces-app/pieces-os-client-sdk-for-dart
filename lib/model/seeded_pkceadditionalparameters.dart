  ...
  static SeededPKCEADDITIONALPARAMETERS? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SeededPKCEADDITIONALPARAMETERS(
        accessType: SeededPKCEADDITIONALPARAMETERSAccessTypeEnum.fromJson(json[r'access_type']) ?? 'UNKNOWN',
        display: SeededPKCEADDITIONALPARAMETERSDisplayEnum.fromJson(json[r'display']) ?? 'UNKNOWN',
      );
    }
    return null;
  }
