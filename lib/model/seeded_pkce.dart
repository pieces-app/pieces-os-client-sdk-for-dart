  ...
  static SeededPKCE? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SeededPKCE(
        ...
        prompt: SeededPKCEPromptEnum.fromJson(json[r'prompt']) ?? SeededPKCEPromptEnum.UNKNOWN,
        redirectUri: mapValueOfType<String>(json, r'redirect_uri'),
        responseMode: SeededPKCEResponseModeEnum.fromJson(json[r'response_mode']) ?? SeededPKCEResponseModeEnum.UNKNOWN,
        ...
        screenHint: SeededPKCEScreenHintEnum.fromJson(json[r'screen_hint']) ?? SeededPKCEScreenHintEnum.UNKNOWN,
