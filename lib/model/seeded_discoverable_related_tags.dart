...
import '/model/seeded_discoverable_related_tag.dart' show SeededDiscoverableRelatedTag;
...
class SeededDiscoverableRelatedTags {
  ...
  @override
  String toString() => 'SeededDiscoverableRelatedTags[schema=$schema, iterable=$iterable, application=$application]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, SeededDiscoverableRelatedTags> map) {
