...
class OCRAnalysis {
  ...
  @override
  String toString() => 'OCRAnalysis[schema=$schema, id=$id, raw=$raw, hocr=$hocr, image=$image, model=$model]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, OCRAnalysis> map) {
