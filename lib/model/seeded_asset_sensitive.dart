...
class SeededAssetSensitive {
  ...
  @override
  String toString() => 'SeededAssetSensitive[category=$category, description=$description, mechanism=$mechanism, metadata=$metadata, name=$name, schema=$schema, severity=$severity, text=$text]';
