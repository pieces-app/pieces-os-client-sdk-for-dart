...
class Users {
  ...
  @override
  String toString() => 'Users[schema=$schema, iterable=$iterable]';
  ...
  static Users? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Users(
        ...
        iterable: UserProfile.listFromJson(json[r'iterable']),
      );
    }
    return null;
  }
  ...
  static Map<String, dynamic> mapToJson(Map<String, Users> map) {
