...
class Application {
  ...
  @override
  String toString() => 'Application[automaticUnload=$automaticUnload, capabilities=$capabilities, descriptor=$descriptor, enrichment=$enrichment, id=$id, mechanism=$mechanism, name=$name, onboarded=$onboarded, platform=$platform, privacy=$privacy, schema=$schema, version=$version]';
