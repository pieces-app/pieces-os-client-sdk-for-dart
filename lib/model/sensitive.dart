...
class Sensitive {
  ...
  @override
  String toString() => 'Sensitive[asset=$asset, category=$category, created=$created, deleted=$deleted, description=$description, id=$id, interactions=$interactions, mechanism=$mechanism, metadata=$metadata, name=$name, schema=$schema, score=$score, severity=$severity, text=$text, updated=$updated]';
