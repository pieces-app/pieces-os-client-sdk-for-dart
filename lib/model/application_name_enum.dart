...
class ApplicationNameEnum {
  ...
  static const EMBEETLE = ApplicationNameEnum._(r'EMBEETLE');
  static const ECLIPSE = ApplicationNameEnum._(r'ECLIPSE');
  static const X_CODE = ApplicationNameEnum._(r'X_CODE');
  static const NETBEANS = ApplicationNameEnum._(r'NETBEANS');
  static const OPERA = ApplicationNameEnum._(r'OPERA');
  static const PIECES_SAVED_MATERIALS_APPLET = ApplicationNameEnum._(r'PIECES_SAVED_MATERIALS_APPLET');
  static const PIECES_SETTINGS_APPLET = ApplicationNameEnum._(r'PIECES_SETTINGS_APPLET');
  static const PIECES_WORKSTREAM_ACTIVITY_APPLET = ApplicationNameEnum._(r'PIECES_WORKSTREAM_ACTIVITY_APPLET');
  static const PIECES_OS_TOOLBAR_APPLET = ApplicationNameEnum._(r'PIECES_OS_TOOLBAR_APPLET');
  static const PIECES_COPILOT_APPLET = ApplicationNameEnum._(r'PIECES_COPILOT_APPLET');
  static const MCP_CLIENT = ApplicationNameEnum._(r'MCP_CLIENT');
  ...
  static const values = <ApplicationNameEnum>[
    ...
    NETBEANS,
    OPERA,
    PIECES_SAVED_MATERIALS_APPLET,
    PIECES_SETTINGS_APPLET,
    PIECES_WORKSTREAM_ACTIVITY_APPLET,
    PIECES_OS_TOOLBAR_APPLET,
    PIECES_COPILOT_APPLET,
    MCP_CLIENT,
  ];
  ...
  ApplicationNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'EMBEETLE': return ApplicationNameEnum.EMBEETLE;
        case r'ECLIPSE': return ApplicationNameEnum.ECLIPSE;
        case r'X_CODE': return ApplicationNameEnum.X_CODE;
        case r'NETBEANS': return ApplicationNameEnum.NETBEANS;
        case r'OPERA': return ApplicationNameEnum.OPERA;
        case r'PIECES_SAVED_MATERIALS_APPLET': return ApplicationNameEnum.PIECES_SAVED_MATERIALS_APPLET;
        case r'PIECES_SETTINGS_APPLET': return ApplicationNameEnum.PIECES_SETTINGS_APPLET;
        case r'PIECES_WORKSTREAM_ACTIVITY_APPLET': return ApplicationNameEnum.PIECES_WORKSTREAM_ACTIVITY_APPLET;
        case r'PIECES_OS_TOOLBAR_APPLET': return ApplicationNameEnum.PIECES_OS_TOOLBAR_APPLET;
        case r'PIECES_COPILOT_APPLET': return ApplicationNameEnum.PIECES_COPILOT_APPLET;
        case r'MCP_CLIENT': return ApplicationNameEnum.MCP_CLIENT;
        default:
          if (!allowNull) {
