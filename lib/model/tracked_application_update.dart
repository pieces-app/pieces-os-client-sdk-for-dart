  ...
  static TrackedApplicationUpdate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TrackedApplicationUpdate(
        ...
        current: TrackedApplication.fromJson(json[r'current'])!,
        previous: TrackedApplication.fromJson(json[r'previous']),
