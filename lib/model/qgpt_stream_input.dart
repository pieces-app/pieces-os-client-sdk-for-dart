...
import '/model/qgpt_question_input.dart' show QGPTQuestionInput;
import '/model/qgpt_relevance_input.dart' show QGPTRelevanceInput;
...
class QGPTStreamInput {
  ...
  @override
  String toString() => 'QGPTStreamInput[relevance=$relevance, question=$question, request=$request, conversation=$conversation, stop=$stop]';
