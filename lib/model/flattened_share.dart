...
class FlattenedShare {
  ...
  @override
  String toString() => 'FlattenedShare[access=$access, accessors=$accessors, asset=$asset, assets=$assets, created=$created, distributions=$distributions, id=$id, link=$link, name=$name, schema=$schema, score=$score, short=$short, user=$user]';
