...
import '/model/hint_type_enum.dart' show HintTypeEnum;
...
class Hint {
  ...
  @override
  String toString() => 'Hint[schema=$schema, id=$id, created=$created, updated=$updated, deleted=$deleted, mechanism=$mechanism, asset=$asset, type=$type, text=$text, model=$model, score=$score]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Hint> map) {
