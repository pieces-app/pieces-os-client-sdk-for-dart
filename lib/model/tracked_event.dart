...
class TrackedEvent {
  ...
  @override
  String toString() => 'TrackedEvent[asset=$asset, format=$format, interaction=$interaction, keyboard=$keyboard, session=$session, assets=$assets, id=$id, ml=$ml, adoption=$adoption]';
