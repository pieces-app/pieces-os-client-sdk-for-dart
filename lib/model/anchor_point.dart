...
class AnchorPoint {
  ...
  @override
  String toString() => 'AnchorPoint[anchor=$anchor, created=$created, deleted=$deleted, fullpath=$fullpath, id=$id, platform=$platform, schema=$schema, score=$score, updated=$updated, verified=$verified]';
