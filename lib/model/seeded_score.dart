...
class SeededScore {
  ...
  @override
  String toString() => 'SeededScore[schema=$schema, reuse=$reuse, update=$update, reference=$reference, priority=$priority]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, SeededScore> map) {
