...
import '/model/analytics_identifiers.dart' show AnalyticsIdentifiers;
import '/model/analytics_tracked_application.dart' show AnalyticsTrackedApplication;
import '/model/analytics_tracked_os.dart' show AnalyticsTrackedOS;
import '/model/seeded_tracked_event.dart' show SeededTrackedEvent;
...
class SeededAnalyticsTrackedGlobalEvent {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  AnalyticsTrackedApplication? application;
  ...
  static SeededAnalyticsTrackedGlobalEvent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SeededAnalyticsTrackedGlobalEvent(
        ...
        application: AnalyticsTrackedApplication.fromJson(json[r'application']),
