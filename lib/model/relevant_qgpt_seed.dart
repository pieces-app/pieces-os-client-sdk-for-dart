...
class RelevantQGPTSeed {
  ...
  @override
  String toString() => 'RelevantQGPTSeed[schema=$schema, id=$id, seed=$seed, path=$path, asset=$asset]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, RelevantQGPTSeed> map) {
