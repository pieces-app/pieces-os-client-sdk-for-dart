...
class ModelUsageEnum {
  ...
  static const UNKNOWN = ModelUsageEnum._(r'UNKNOWN');
  ...
  static const TECHNICAL_ERROR = ModelUsageEnum._(r'TECHNICAL_ERROR');
...
class ModelUsageEnumTypeTransformer {
  ...
  ModelUsageEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'UNKNOWN': return ModelUsageEnum.UNKNOWN;
        ...
        case r'TECHNICAL_ERROR': return ModelUsageEnum.TECHNICAL_ERROR;
        default:
          if (!allowNull) {
