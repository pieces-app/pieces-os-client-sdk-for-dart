...
import '/model/available_formats.dart' show AvailableFormats;
import '/model/embedded_model_schema.dart' show EmbeddedModelSchema;
import '/model/seeded_asset_metadata.dart' show SeededAssetMetadata;
import '/model/seeded_format.dart' show SeededFormat;
...
class SeededAsset {
  ...
  @override
  String toString() => 'SeededAsset[schema=$schema, metadata=$metadata, application=$application, format=$format, discovered=$discovered, available=$available, pseudo=$pseudo]';
