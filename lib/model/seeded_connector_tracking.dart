...
import '/model/seeded_tracked_adoption_event.dart' show SeededTrackedAdoptionEvent;
import '/model/seeded_tracked_asset_event.dart' show SeededTrackedAssetEvent;
import '/model/seeded_tracked_assets_event.dart' show SeededTrackedAssetsEvent;
import '/model/seeded_tracked_format_event.dart' show SeededTrackedFormatEvent;
import '/model/seeded_tracked_interaction_event.dart' show SeededTrackedInteractionEvent;
import '/model/seeded_tracked_keyboard_event.dart' show SeededTrackedKeyboardEvent;
import '/model/seeded_tracked_machine_learning_event.dart' show SeededTrackedMachineLearningEvent;
import '/model/seeded_tracked_session_event.dart' show SeededTrackedSessionEvent;
...
class SeededConnectorTracking {
  ...
  @override
  String toString() => 'SeededConnectorTracking[schema=$schema, format=$format, asset=$asset, interaction=$interaction, keyboard=$keyboard, session=$session, assets=$assets, ml=$ml, adoption=$adoption]';
