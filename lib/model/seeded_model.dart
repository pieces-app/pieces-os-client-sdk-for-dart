...
class SeededModel {
  ...
  @override
  String toString() => 'SeededModel[schema=$schema, version=$version, created=$created, name=$name, description=$description, cloud=$cloud, type=$type, usage=$usage, bytes=$bytes, ram=$ram, quantization=$quantization, foundation=$foundation, downloaded=$downloaded, unique=$unique, parameters=$parameters, provider=$provider, cpu=$cpu]';
