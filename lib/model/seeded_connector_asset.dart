...
class SeededConnectorAsset {
  ...
  @override
  String toString() => 'SeededConnectorAsset[schema=$schema, metadata=$metadata, format=$format]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, SeededConnectorAsset> map) {
