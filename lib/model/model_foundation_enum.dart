...
class ModelFoundationEnum {
  ...
  static const UNKNOWN = ModelFoundationEnum._(r'UNKNOWN');
  ...
  static const gEMINI2 = ModelFoundationEnum._(r'GEMINI_2');
  ...
  static const gEMMA29B = ModelFoundationEnum._(r'GEMMA_2_9B');
  static const pHI3MINI = ModelFoundationEnum._(r'PHI_3_MINI');
  static const pHI3SMALL = ModelFoundationEnum._(r'PHI_3_SMALL');
  static const gRANITE3B = ModelFoundationEnum._(r'GRANITE_3B');
  static const gRANITE8B = ModelFoundationEnum._(r'GRANITE_8B');
  static const lLAMA38B = ModelFoundationEnum._(r'LLAMA_3_8B');
  static const cLAUDE3Period5 = ModelFoundationEnum._(r'CLAUDE_3.5');
  static const cLAUDE4 = ModelFoundationEnum._(r'CLAUDE_4');
  static const CLAUDE_LATEST = ModelFoundationEnum._(r'CLAUDE_LATEST');
  static const GRANITE_LATEST = ModelFoundationEnum._(r'GRANITE_LATEST');
  static const LLAMA_LATEST = ModelFoundationEnum._(r'LLAMA_LATEST');
  static const PHI_LATEST = ModelFoundationEnum._(r'PHI_LATEST');
  static const GEMMA_LATEST = ModelFoundationEnum._(r'GEMMA_LATEST');
  static const GEMINI_LATEST = ModelFoundationEnum._(r'GEMINI_LATEST');
  static const GPT_LATEST = ModelFoundationEnum._(r'GPT_LATEST');
  static const AZURE_LATEST = ModelFoundationEnum._(r'AZURE_LATEST');
  static const AZURE_FAST = ModelFoundationEnum._(r'AZURE_FAST');
  static const AZURE_BEST = ModelFoundationEnum._(r'AZURE_BEST');
  static const AZURE_DEFAULT = ModelFoundationEnum._(r'AZURE_DEFAULT');
  static const AZURE_CUSTOM = ModelFoundationEnum._(r'AZURE_CUSTOM');
  static const PERPLEXITY_LATEST = ModelFoundationEnum._(r'PERPLEXITY_LATEST');
  static const PERPLEXITY_FAST = ModelFoundationEnum._(r'PERPLEXITY_FAST');
  static const PERPLEXITY_BEST = ModelFoundationEnum._(r'PERPLEXITY_BEST');
  static const PERPLEXITY_DEFAULT = ModelFoundationEnum._(r'PERPLEXITY_DEFAULT');
  static const PERPLEXITY_CUSTOM = ModelFoundationEnum._(r'PERPLEXITY_CUSTOM');
  static const CODESTRAL_LATEST = ModelFoundationEnum._(r'CODESTRAL_LATEST');
  static const DEEPSEEK_LATEST = ModelFoundationEnum._(r'DEEPSEEK_LATEST');
  static const LLAVA_LATEST = ModelFoundationEnum._(r'LLAVA_LATEST');
  static const MIXTRAL_LATEST = ModelFoundationEnum._(r'MIXTRAL_LATEST');
  static const MISTRAL_LATEST = ModelFoundationEnum._(r'MISTRAL_LATEST');
  static const ORCA_LATEST = ModelFoundationEnum._(r'ORCA_LATEST');
  static const QWEN_CODER_LATEST = ModelFoundationEnum._(r'QWEN_CODER_LATEST');
  static const QWEN_LATEST = ModelFoundationEnum._(r'QWEN_LATEST');
  static const QWQ_LATEST = ModelFoundationEnum._(r'QWQ_LATEST');
  static const STARCODER_LATEST = ModelFoundationEnum._(r'STARCODER_LATEST');
  static const TINYLLAMA_LATEST = ModelFoundationEnum._(r'TINYLLAMA_LATEST');
  static const VICUNA_LATEST = ModelFoundationEnum._(r'VICUNA_LATEST');
  static const WIZARD_LATEST = ModelFoundationEnum._(r'WIZARD_LATEST');
  static const ZEPHYR_LATEST = ModelFoundationEnum._(r'ZEPHYR_LATEST');
  static const POTION = ModelFoundationEnum._(r'POTION');
...
class ModelFoundationEnumTypeTransformer {
  ...
  ModelFoundationEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'UNKNOWN': return ModelFoundationEnum.UNKNOWN;
        ...
        case r'GEMINI_2': return ModelFoundationEnum.gEMINI2;
        ...
        case r'GEMMA_2_9B': return ModelFoundationEnum.gEMMA29B;
        case r'PHI_3_MINI': return ModelFoundationEnum.pHI3MINI;
        case r'PHI_3_SMALL': return ModelFoundationEnum.pHI3SMALL;
        case r'GRANITE_3B': return ModelFoundationEnum.gRANITE3B;
        case r'GRANITE_8B': return ModelFoundationEnum.gRANITE8B;
        case r'LLAMA_3_8B': return ModelFoundationEnum.lLAMA38B;
        case r'CLAUDE_3.5': return ModelFoundationEnum.cLAUDE3Period5;
        case r'CLAUDE_4': return ModelFoundationEnum.cLAUDE4;
        case r'CLAUDE_LATEST': return ModelFoundationEnum.CLAUDE_LATEST;
        case r'GRANITE_LATEST': return ModelFoundationEnum.GRANITE_LATEST;
        case r'LLAMA_LATEST': return ModelFoundationEnum.LLAMA_LATEST;
        case r'PHI_LATEST': return ModelFoundationEnum.PHI_LATEST;
        case r'GEMMA_LATEST': return ModelFoundationEnum.GEMMA_LATEST;
        case r'GEMINI_LATEST': return ModelFoundationEnum.GEMINI_LATEST;
        case r'GPT_LATEST': return ModelFoundationEnum.GPT_LATEST;
        case r'AZURE_LATEST': return ModelFoundationEnum.AZURE_LATEST;
        case r'AZURE_FAST': return ModelFoundationEnum.AZURE_FAST;
        case r'AZURE_BEST': return ModelFoundationEnum.AZURE_BEST;
        case r'AZURE_DEFAULT': return ModelFoundationEnum.AZURE_DEFAULT;
        case r'AZURE_CUSTOM': return ModelFoundationEnum.AZURE_CUSTOM;
        case r'PERPLEXITY_LATEST': return ModelFoundationEnum.PERPLEXITY_LATEST;
        case r'PERPLEXITY_FAST': return ModelFoundationEnum.PERPLEXITY_FAST;
        case r'PERPLEXITY_BEST': return ModelFoundationEnum.PERPLEXITY_BEST;
        case r'PERPLEXITY_DEFAULT': return ModelFoundationEnum.PERPLEXITY_DEFAULT;
        case r'PERPLEXITY_CUSTOM': return ModelFoundationEnum.PERPLEXITY_CUSTOM;
        case r'CODESTRAL_LATEST': return ModelFoundationEnum.CODESTRAL_LATEST;
        case r'DEEPSEEK_LATEST': return ModelFoundationEnum.DEEPSEEK_LATEST;
        case r'LLAVA_LATEST': return ModelFoundationEnum.LLAVA_LATEST;
        case r'MIXTRAL_LATEST': return ModelFoundationEnum.MIXTRAL_LATEST;
        case r'MISTRAL_LATEST': return ModelFoundationEnum.MISTRAL_LATEST;
        case r'ORCA_LATEST': return ModelFoundationEnum.ORCA_LATEST;
        case r'QWEN_CODER_LATEST': return ModelFoundationEnum.QWEN_CODER_LATEST;
        case r'QWEN_LATEST': return ModelFoundationEnum.QWEN_LATEST;
        case r'QWQ_LATEST': return ModelFoundationEnum.QWQ_LATEST;
        case r'STARCODER_LATEST': return ModelFoundationEnum.STARCODER_LATEST;
        case r'TINYLLAMA_LATEST': return ModelFoundationEnum.TINYLLAMA_LATEST;
        case r'VICUNA_LATEST': return ModelFoundationEnum.VICUNA_LATEST;
        case r'WIZARD_LATEST': return ModelFoundationEnum.WIZARD_LATEST;
        case r'ZEPHYR_LATEST': return ModelFoundationEnum.ZEPHYR_LATEST;
        case r'POTION': return ModelFoundationEnum.POTION;
        default:
          if (!allowNull) {
