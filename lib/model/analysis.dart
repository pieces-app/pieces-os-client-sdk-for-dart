...
class Analysis {
  ...
  @override
  String toString() => 'Analysis[schema=$schema, code=$code, id=$id, format=$format, image=$image]';
  ...
  static Analysis? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Analysis(
        ...
        image: ImageAnalysis.fromJson(json[r'image']),
      );
    }
    return null;
  }
  ...
  static Map<String, dynamic> mapToJson(Map<String, Analysis> map) {
