...
import '/model/auth0_user_allocation_metadata.dart' show Auth0UserAllocationMetadata;
...
class Auth0UserMetadata {
  ...
  @override
  String toString() => 'Auth0UserMetadata[schema=$schema, globalId=$globalId, cloudKey=$cloudKey, stripeCustomerId=$stripeCustomerId, vanityname=$vanityname, allocation=$allocation]';
