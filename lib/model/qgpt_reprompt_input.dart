...
import '/model/qgpt_conversation.dart' show QGPTConversation;
...
class QGPTRepromptInput {
  ...
  @override
  String toString() => 'QGPTRepromptInput[schema=$schema, query=$query, conversation=$conversation, application=$application, model=$model]';
