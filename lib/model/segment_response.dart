...
class SegmentResponse {
  ...
  @override
  String toString() => 'SegmentResponse[schema=$schema, success=$success]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SegmentResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SegmentResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static Map<String, dynamic> mapToJson(Map<String, SegmentResponse> map) {
