...
import '/model/flattened_tags.dart' show FlattenedTags;
import '/model/flattened_websites.dart' show FlattenedWebsites;
import '/model/grouped_timestamp.dart' show GroupedTimestamp;
import '/model/mechanism_enum.dart' show MechanismEnum;
import '/model/person_access.dart' show PersonAccess;
import '/model/person_model.dart' show PersonModel;
import '/model/person_type.dart' show PersonType;
...
class Person {
  ...
  @override
  String toString() => 'Person[schema=$schema, id=$id, created=$created, updated=$updated, deleted=$deleted, type=$type, assets=$assets, mechanisms=$mechanisms, interactions=$interactions, access=$access, tags=$tags, websites=$websites, models=$models, annotations=$annotations, score=$score]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Person> map) {
