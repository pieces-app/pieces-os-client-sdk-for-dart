...
class Website {
  ...
  @override
  String toString() => 'Website[schema=$schema, id=$id, assets=$assets, url=$url, name=$name, created=$created, updated=$updated, deleted=$deleted, mechanisms=$mechanisms, interactions=$interactions, persons=$persons, score=$score]';
