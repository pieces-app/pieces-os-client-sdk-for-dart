...
class FlattenedHint {
  ...
  @override
  String toString() => 'FlattenedHint[assets=$assets, created=$created, deleted=$deleted, id=$id, mechanisms=$mechanisms, model=$model, schema=$schema, score=$score, text=$text, type=$type, updated=$updated]';
