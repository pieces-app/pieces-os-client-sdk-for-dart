...
import '/model/annotation_type_enum.dart' show AnnotationTypeEnum;
...
class Annotation {
  ...
  @override
  String toString() => 'Annotation[schema=$schema, id=$id, created=$created, updated=$updated, deleted=$deleted, mechanism=$mechanism, asset=$asset, person=$person, type=$type, text=$text, model=$model, pseudo=$pseudo, favorited=$favorited, anchor=$anchor, conversation=$conversation, score=$score, messages=$messages]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, Annotation> map) {
