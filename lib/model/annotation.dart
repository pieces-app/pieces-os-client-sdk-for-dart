...
class Annotation {
  ...
  @override
  String toString() => 'Annotation[anchor=$anchor, anchors=$anchors, asset=$asset, assets=$assets, conversation=$conversation, conversations=$conversations, created=$created, deleted=$deleted, favorited=$favorited, id=$id, mechanism=$mechanism, messages=$messages, model=$model, person=$person, persons=$persons, pseudo=$pseudo, schema=$schema, score=$score, summaries=$summaries, summary=$summary, tags=$tags, text=$text, type=$type, updated=$updated, websites=$websites, workstreamEvents=$workstreamEvents]';
