...
import '/model/relevant_qgpt_seeds.dart' show RelevantQGPTSeeds;
...
class QGPTQuestionInput {
  ...
  @override
  String toString() => 'QGPTQuestionInput[schema=$schema, relevant=$relevant, query=$query, application=$application, model=$model, messages=$messages]';
