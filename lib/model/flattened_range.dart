...
class FlattenedRange {
  ...
  @override
  String toString() => 'FlattenedRange[between=$between, conversations=$conversations, created=$created, from=$from, id=$id, messages=$messages, schema=$schema, score=$score, summaries=$summaries, to=$to, updated=$updated]';
