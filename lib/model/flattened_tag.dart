...
import '/model/tag_category_enum.dart' show TagCategoryEnum;
...
class FlattenedTag {
  ...
  @override
  String toString() => 'FlattenedTag[schema=$schema, id=$id, text=$text, mechanisms=$mechanisms, assets=$assets, created=$created, updated=$updated, deleted=$deleted, category=$category, relationship=$relationship, interactions=$interactions, persons=$persons, score=$score]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, FlattenedTag> map) {
