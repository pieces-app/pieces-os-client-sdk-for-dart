...
class FlattenedSubscription {
  /// Returns a new [FlattenedSubscription] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FlattenedSubscription &&
    other.active == active &&
  ...
  /// Returns a new [FlattenedSubscription] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FlattenedSubscription? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FlattenedSubscription[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FlattenedSubscription[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FlattenedSubscription(
  ...
  static List<FlattenedSubscription> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FlattenedSubscription>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FlattenedSubscription.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FlattenedSubscription> mapFromJson(dynamic json) {
    final map = <String, FlattenedSubscription>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FlattenedSubscription.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FlattenedSubscription-objects as value to a dart map
  static Map<String, List<FlattenedSubscription>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FlattenedSubscription>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FlattenedSubscription.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
