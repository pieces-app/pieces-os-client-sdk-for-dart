...
import '/model/flattened_hint.dart' show FlattenedHint;
...
class ReferencedHint {
  ...
  @override
  String toString() => 'ReferencedHint[schema=$schema, id=$id, reference=$reference]';
  ...
  static Map<String, dynamic> mapToJson(Map<String, ReferencedHint> map) {
