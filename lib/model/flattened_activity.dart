...
class FlattenedActivity {
  ...
  @override
  String toString() => 'FlattenedActivity[application=$application, asset=$asset, created=$created, deleted=$deleted, event=$event, format=$format, id=$id, mechanism=$mechanism, rank=$rank, schema=$schema, updated=$updated, user=$user]';
