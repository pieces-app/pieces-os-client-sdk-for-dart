...
class AssetApi {
  ...
  Future<Response> assetAssociateAnnotationWithHttpInfo(String asset, String annotation,) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/{asset}/annotations/associate/{annotation}'
      .replaceAll('{asset}', asset)
  ...
  /// * [String] annotation (required):
  ///   This is a specific annotation uuid.
  Future<void> assetAssociateAnnotation(String asset, String annotation,) async {
    final response = await assetAssociateAnnotationWithHttpInfo(asset, annotation,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> assetAssociateConversationMessageWithHttpInfo(String asset, String message,) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/{asset}/messages/associate/{message}'
      .replaceAll('{asset}', asset)
  ...
  /// * [String] message (required):
  ///   This is the uuid of a message.
  Future<void> assetAssociateConversationMessage(String asset, String message,) async {
    final response = await assetAssociateConversationMessageWithHttpInfo(asset, message,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> assetAssociateHintWithHttpInfo(String asset, String hint,) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/{asset}/hints/associate/{hint}'
      .replaceAll('{asset}', asset)
  ...
  /// * [String] hint (required):
  ///   This is a specific hint uuid
  Future<void> assetAssociateHint(String asset, String hint,) async {
    final response = await assetAssociateHintWithHttpInfo(asset, hint,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] annotation (required):
  ///   This is a specific annotation uuid.
  Future<Response> assetDisassociateAnnotationWithHttpInfo(String asset, String annotation,) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/{asset}/annotations/disassociate/{annotation}'
      .replaceAll('{asset}', asset)
      .replaceAll('{annotation}', annotation);
  ...
  /// * [String] annotation (required):
  ///   This is a specific annotation uuid.
  Future<void> assetDisassociateAnnotation(String asset, String annotation,) async {
    final response = await assetDisassociateAnnotationWithHttpInfo(asset, annotation,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] message (required):
  ///   This is the uuid of a message.
  Future<Response> assetDisassociateConversationMessageWithHttpInfo(String asset, String message,) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/{asset}/messages/disassociate/{message}'
      .replaceAll('{asset}', asset)
      .replaceAll('{message}', message);
  ...
  /// * [String] message (required):
  ///   This is the uuid of a message.
  Future<void> assetDisassociateConversationMessage(String asset, String message,) async {
    final response = await assetDisassociateConversationMessageWithHttpInfo(asset, message,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] hint (required):
  ///   This is a specific hint uuid
  Future<Response> assetDisassociateHintWithHttpInfo(String asset, String hint,) async {
    // ignore: prefer_const_declarations
    final path = r'/asset/{asset}/hints/disassociate/{hint}'
      .replaceAll('{asset}', asset)
      .replaceAll('{hint}', hint);
  ...
  /// * [String] hint (required):
  ///   This is a specific hint uuid
  Future<void> assetDisassociateHint(String asset, String hint,) async {
    final response = await assetDisassociateHintWithHttpInfo(asset, hint,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> assetReclassifyWithHttpInfo({ bool? transferables, AssetReclassification? assetReclassification, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = assetReclassification;
  ...
  Future<Response> assetSnapshotWithHttpInfo(String asset, { bool? transferables, bool? packageActivities, }) async {
    // ignore: prefer_const_declarations
  ...
  Future<Asset?> assetSnapshot(String asset, { bool? transferables, bool? packageActivities, }) async {
    final response = await assetSnapshotWithHttpInfo(asset,  transferables: transferables, packageActivities: packageActivities, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> assetSnapshotPostWithHttpInfo(String asset, { bool? transferables, SeededAccessor? seededAccessor, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = seededAccessor;
  ...
  Future<Conversations?> assetSpecificAssetConversations(String asset, { bool? transferables, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'Conversations',) as Conversations;
  ...
  Future<Response> assetSpecificAssetExportWithHttpInfo(String asset, String exportType,) async {
    ...
    final formParams = <String, String>{};
      ...
      queryParams.addAll(_queryParams('', 'export_type', exportType));
  ...
  Future<ExportedAsset?> assetSpecificAssetExport(String asset, String exportType,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ExportedAsset',) as ExportedAsset;
