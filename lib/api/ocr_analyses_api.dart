...
import '/api.dart' show defaultApiClient, ApiException;
    ...
    OCRAnalysesApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
    ...
    final ApiClient apiClient;
        ...
        Future<Response> ocrAnalysesSnapshotWithHttpInfo({ bool? transferables, }) async {
            // ignore: prefer_const_declarations
            final path = r'/ocr_analyses';
            ...
            final response = await ocrAnalysesSnapshotWithHttpInfo( transferables: transferables, );
            ...
            throw ApiException(response.statusCode, await decodeBodyBytes(response));
                ...
                if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
                            return await apiClient.deserializeAsync(await decodeBodyBytes(response), 'OCRAnalyses',) as OCRAnalyses;
