...
class QGPTApi {
  ...
  Future<Response> hintsWithHttpInfo({ QGPTHintsInput? qGPTHintsInput, }) async {
    ...
    Object? postBody = qGPTHintsInput;
  ...
  Future<QGPTQuestionOutput?> hints({ QGPTHintsInput? qGPTHintsInput, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'QGPTQuestionOutput',) as QGPTQuestionOutput;
  ...
  Future<Response> personsRelatedWithHttpInfo({ bool? transferables, QGPTPersonsRelatedInput? qGPTPersonsRelatedInput, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = qGPTPersonsRelatedInput;
  ...
  Future<QGPTPersonsRelatedOutput?> personsRelated({ bool? transferables, QGPTPersonsRelatedInput? qGPTPersonsRelatedInput, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'QGPTPersonsRelatedOutput',) as QGPTPersonsRelatedOutput;
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> qgptBehaviorSpecificRetrievalActivationsWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/qgpt/behavior_specific_retrieval/activations';
  ...
  Future<QGPTBehaviorSpecificRetrievalActivationsOutput?> qgptBehaviorSpecificRetrievalActivations() async {
    final response = await qgptBehaviorSpecificRetrievalActivationsWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'QGPTBehaviorSpecificRetrievalActivationsOutput',) as QGPTBehaviorSpecificRetrievalActivationsOutput;
  ...
  Future<Response> qgptStreamWithHttpInfo({ QGPTStreamInput? qGPTStreamInput, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = qGPTStreamInput;
  ...
  Future<QGPTStreamOutput?> qgptStream({ QGPTStreamInput? qGPTStreamInput, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'QGPTStreamOutput',) as QGPTStreamOutput;
  ...
  Future<Response> questionWithHttpInfo({ QGPTQuestionInput? qGPTQuestionInput, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = qGPTQuestionInput;
  ...
  Future<Response> relevanceWithHttpInfo({ QGPTRelevanceInput? qGPTRelevanceInput, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = qGPTRelevanceInput;
  ...
  Future<QGPTRelevanceOutput?> relevance({ QGPTRelevanceInput? qGPTRelevanceInput, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'QGPTRelevanceOutput',) as QGPTRelevanceOutput;
  ...
  Future<Response> repromptWithHttpInfo({ QGPTRepromptInput? qGPTRepromptInput, }) async {
    ...
    // ignore: prefer_final_locals
    Object? postBody = qGPTRepromptInput;
  ...
  Future<QGPTRepromptOutput?> reprompt({ QGPTRepromptInput? qGPTRepromptInput, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'QGPTRepromptOutput',) as QGPTRepromptOutput;
