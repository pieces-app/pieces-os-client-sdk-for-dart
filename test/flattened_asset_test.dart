...
// tests for FlattenedAsset
void main() {
  // final instance = FlattenedAsset();

  group('test FlattenedAsset', () {
    ...
    test('to test the property `interacted`', () async {
      // TODO
    });
    ...
    // bool curated
    test('to test the property `curated`', () async {
      // TODO
    });
